...
export default function DesignMagicBanner() {
  return (
    <section className="py-16 xl:py-24 2xl:py-28">
      <div
        className="relative mx-auto flex w-full max-w-[1320px] flex-col items-center gap-8 px-6 py-12 text-center"
      >
        {/* 2025-10-29: 顶部标签组 */}
        <div className="flex items-center overflow-hidden rounded-[100px] border border-[rgba(255,255,255,0.2)] bg-[#191919] text-white">
        ...
        {/* 2025-10-29: 核心文案标题 */}
        <h3 className="text-[32px] font-medium leading-[1.3] text-white">
          幕后的魔法：AI如何让海报设计更简单
        </h3>
      </div>
    </section>
