...
export default function SocialMedia() {
  ...
  return (
    <section className="py-20 relative text-center overflow-visible">
      <GlowEffect
        top="-10rem"
        ...
        alt="灵感光影"
        priority={false}
        className="left-1/2 -translate-x-1/2 z-[60] w-[1200px] h-[1200px]"
        imageClassName="rounded-[44px]"
      />

      <h2 className="text-3xl font-bold text-white lg:text-4xl">社交媒体</h2>
      <p className="mx-auto mt-4 max-w-2xl text-base text-white/85 lg:text-lg">
      ...
      <div className="mt-8 flex items-center justify-center gap-6">
        ...
        >
          <svg className="h-6 w-6" viewBox="0 0 16 16" fill="#AE89FF">
        ...
        >
          <svg className="h-6 w-6" viewBox="0 0 21 16" fill="#AE89FF">
